...
mkdir -p -v /home/$(users)/Documents/FS-UAE/Hard\ Drives
mkdir -p -v /home/$(users)/Documents/FS-UAE/Hard\ Drives/Work
rsync --progress hdf/* /home/$(users)/Documents/FS-UAE/Hard\ Drives

mkdir -p -v /home/$(users)/Documents/FS-UAE/Kickstarts
rsync --progress rom/* /home/$(users)/Documents/FS-UAE/Kickstarts/

mkdir -p -v /home/$(users)/Documents/FS-UAE/Floppies
rsync --progress adf/*.adf /home/$(users)/Documents/FS-UAE/Floppies/
