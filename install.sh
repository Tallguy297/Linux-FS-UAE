...
cp -v -f configs/*.fs-uae /home/$(users)/Documents/FS-UAE/Configurations/

mkdir -p -v /home/$(users)/Documents/FS-UAE/Hard\ Drives/Work/WBSystems
rsync -ah --progress wbsystems/*.lha /home/$(users)/Documents/FS-UAE/Hard\ Drives/Work/WBSystems
